...
const kozosTerminal = {
  src: `${imageDir}/kozos-terminal.png`,
  caption: '完成したOS',
  alt: '完成したOS',
};
const kozosBoard = {
  src: `${imageDir}/kozos-board.jpg`,
  caption: 'H8/3069Fマイコン・ボードにシリアル・ケーブルとACアダプターをつなげたもの',
  alt: 'H8/3069Fマイコン・ボードにシリアル・ケーブルとACアダプターをつなげたもの',
};
...
<ImageWithCaption {...kozosTerminal} />
